...
my_env = omgeving() #high reward context omgeving
...
def runningmodel(a,b, eq = True, pref = 0.2):  
    ...
    for i in range(N):   
        ...
        strategy = run_active_inference_loop(my_agent,my_env, T = T, equal = eq)  #on this line you can change between high or low reward context
