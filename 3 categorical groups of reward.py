...
D1_names = ['High','Medium','Low']
D2_names = ['High','Medium','Low']
...
reward_obs_names = ['Null', 'High','Medium', 'Low']
...
prob_win1 = [1/3,1/3,1/3] # what is the probability of high and low reward for deck1
prob_win2 = [0.5,0.3,0.2] # what is the probability of high and low reward for deck2
...
for choice_id, choice_name in enumerate(choice_names):
    ...
    if choice_name == 'Start':
        ...
        for loop in range(len(D1_names)):
            A_reward[1:,:,loop, choice_id] = np.array([[pH1_G+0.1,pH1_M+0.1,pH1_B+0.1],[(1-pH1_G)/2,(1-pH1_M)/2,(1-pH1_B)/2],[(1-pH1_G)/2-0.1,(1-pH1_M)/2-0.1,(1-pH1_B)/2-0.1]])
    
    elif choice_name == 'ChD2':
        
        for loop in range(len(D2_names)):
            A_reward[1:,loop,:, choice_id] = np.array([[pH2_G+0.1,pH2_M+0.1,pH2_B+0.1],[(1-pH2_G)/2,(1-pH2_M)/2,(1-pH2_B)/2],[(1-pH2_G)/2-0.1,(1-pH2_M)/2-0.1,(1-pH2_B)/2-0.1]])
...
D_context1 = np.array([0.5,0.5,0.5])
D_context2 = np.array([0.5,0.5,0.5])
